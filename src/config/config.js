const config = {
  ...
  backendApiEndPoint: 'http://192.168.1.102:5000/',
  ...
  qrCodeEncryptSeparator: '|s3p|',
  qrCodeEncryptKey: 'nL3CyFr4zDTihIDNYY0kXDvgE8CNzccpzdbgHXocTDgK8BNqqN',
};

if (
  config.backendApiEndPoint.includes('localhost') ||
  config.backendApiEndPoint.includes('127.0.0.1')
) {
